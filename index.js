...
const SOURCES = {
  ...
  CHATGPT_AI: "https://chat.openai.com/chat",
  GEMINI_AI: "https://gemini.google.com/app",
  RESPONSIVE_VOICE: "https://responsivevoice.org/",
  ANDREADG_DEV_GH: "https://github.com/andreadg-dev",
};
...
const SENTENCES = [
  ...
  {
    ID: 101,
    MAIN_EN: "After moving out of our old house, we moved into a larger flat.",
    DE: "Nachdem wir aus unserem alten Haus ausgezogen sind, sind wir in eine geräumigere Wohnung gezogen.",
    NL: "Na het verlaten van ons oude huis zijn we verhuisd naar een grotere flat.",
    PT: "Depois de sairmos da nossa antiga casa, mudámo-nos para um apartamento maior.",
    FR: "Après avoir déménagé de notre ancienne maison, nous avons emménagé dans un appartement plus spacieux.",
    ES: "Después de mudarnos de nuestra antigua casa, nos mudamos a un piso más grande.",
    IT: "Dopo aver lasciato la nostra vecchia casa, ci siamo trasferiti in un appartamento più grande.",
  },
  {
    ID: 102,
    MAIN_EN: "Before moving out, we need to get our new house ready for us.",
    DE: "Bevor wir umziehen, müssen wir unser neues Haus einrichten, damit es bereit ist, uns aufzunehmen.",
    NL: "Voordat we verhuizen, moeten we ons nieuwe huis klaarmaken.",
    PT: "Antes de nos mudarmos, temos de preparar a nossa nova casa para nós.",
    FR: "Avant de déménager, nous devons aménager notre nouvelle maison pour qu'elle soit prête à nous accueillir.",
    ES: "Antes de mudarnos, tenemos que preparar nuestra nueva casa.",
    IT: "Prima di traslocare, dobbiamo preparare la nuova casa per noi.",
  },
  {
    ID: 103,
    MAIN_EN:
      "They'll be moving into their new house as soon as they've finished fitting out the living room.",
    DE: "Sie werden in ihr neues Haus einziehen, sobald sie das Wohnzimmer eingerichtet haben.",
    NL: "Ze verhuizen naar hun nieuwe huis zodra ze klaar zijn met het inrichten van de woonkamer.",
    PT: "Eles vão mudar-se para a nova casa assim que acabarem de equipar a sala de estar.",
    FR: "Ils vont emménager dans leur nouvelle maison dès qu'ils auront fini d'aménager le salon.",
    ES: "Se mudarán a su nueva casa en cuanto terminen de acondicionar el salón.",
    IT: "Si trasferiranno nella loro nuova casa non appena avranno finito di sistemare il soggiorno.",
  },
  {
    ID: 104,
    MAIN_EN:
      "Moving to a new city will allow us to discover more about new cultures and traditions.",
    DE: "Der Umzug in eine neue Stadt ermöglicht es uns, mehr von den neuen Kulturen und Traditionen kennenzulernen.",
    NL: "Door te verhuizen naar een nieuwe stad kunnen we meer te weten komen over nieuwe culturen en tradities.",
    PT: "A mudança para uma nova cidade permitir-nos-á descobrir mais sobre novas culturas e tradições.",
    FR: "Déménager dans une nouvelle ville nous permettra de découvrir davantage de nouvelles cultures et traditions.",
    ES: "Mudarnos a una nueva ciudad nos permitirá descubrir nuevas culturas y tradiciones.",
    IT: "Trasferirci in una nuova città ci permetterà di scoprire nuove culture e tradizioni.",
  },
  {
    ID: 105,
    MAIN_EN:
      "By moving to this area, we hope to meet more friendly neighbours.",
    DE: "Durch den Umzug in diese Gegend hoffen wir, mehr nette Nachbarn zu treffen.",
    NL: "Door naar dit gebied te verhuizen, hopen we meer vriendelijke buren te ontmoeten.",
    PT: "Ao mudarmo-nos para esta zona, esperamos encontrar mais vizinhos simpáticos.",
    FR: "En emménageant dans ce quartier, nous espérons rencontrer davantage de voisins sympathiques.",
    ES: "Al mudarnos a esta zona, esperamos conocer a más vecinos amistosos.",
    IT: "Trasferendoci in questa zona, speriamo di incontrare più vicini amichevoli.",
  },
  {
    ID: 106,
    MAIN_EN:
      "We need to see more of each other, because I see a lot of advantages in that.",
    DE: "Wir sollten uns mehr treffen, weil ich viele Vorteile darin sehe.",
    NL: "We moeten elkaar meer gaan zien, want daar zie ik veel voordelen in.",
    PT: "Precisamos de nos ver mais uns aos outros, porque vejo muitas vantagens nisso.",
    FR: "Il faudrait qu'on se voie davantage car j'y vois beaucoup d'avantages.",
    ES: "Tenemos que vernos más, porque le veo muchas ventajas.",
    IT: "Dobbiamo vederci di più, perché vedo molti vantaggi in questo.",
  },
  {
    ID: 107,
    MAIN_EN: "The current situation has more disadvantages than advantages.",
    DE: "Die derzeitige Situation hat mehr Nachteile als Vorteile.",
    NL: "De huidige situatie heeft meer nadelen dan voordelen.",
    PT: "A situação atual tem mais desvantagens do que vantagens.",
    FR: "La situation actuelle présente plus d’inconvénients que d’avantages.",
    ES: "La situación actual tiene más desventajas que ventajas.",
    IT: "La situazione attuale presenta più svantaggi che vantaggi.",
  },
];
